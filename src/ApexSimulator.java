...
/*
    ...
    */
    ...
    public static void DecodeStage() {
        if (pipeline[1][cycleCount] == null && BranchTaken == false) {
    ...
    public static void Execute1Stage() {
        ...
        if (pipeline[4][cycleCount] == null) {
            if (pipeline[1][cycleCount - 1] != null
                    ...
                    && !pipeline[1][cycleCount - 1].opcode.equals("JUMP")) {
